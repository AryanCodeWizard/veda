const About = () => {
  return (
    <section id="about" className="py-20">
      <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 md:grid-cols-[0.9fr_1.1fr]">
        ...
        <div className="rounded-3xl border border-teal-100 bg-white/85 p-8 shadow-xl shadow-teal-950/5">
          <p className="mb-3 text-sm font-semibold uppercase tracking-[0.2em] text-teal-700">About</p>
          <h2 className="mb-5 text-4xl font-bold text-slate-900 md:text-5xl">Ancient Insight, Practical Guidance</h2>
